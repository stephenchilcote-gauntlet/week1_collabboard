...
Use layoutObjects for arranging multiple objects: grid, distributeH/V, or align (left/center/right/top/middle/bottom).
Use getBoardState with filter/fields for fast structured queries, or query for natural language analysis.`;
